...
//for protection of router
const {forwardAuthenticated,ensureAuthenticated}=require('../config/auth');


// set public folder for static files to load
...
router.post('/register',(req,res)=>{
    ...
    //if we find any error,return to sign up page again
    if(errors.length>0)
    {
        res.render('registerCom',{
            errors,
                        ...
                        if(OTP!=req.body.OTP){
                            ...
                            //Using bcrypt, we will hash account's password
                                ...
                                bcrypt.hash(newCompany.password,salt,(err,hash)=>{
                                    ...
                                    newCompany.save()
                                    .then(company=>{
                                        req.flash('success_msg',"You're now registered,can Login");
...
router.post('/OTP/:emailID',(req,res)=>{
    ...
    const transporter = nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: 'vimal8090256885@gmail.com',
        pass: 'lxwzhoiupehirpld' 
      }
    });
...
//will authenticated company and most imp , serialize it as a user
